    ...
    <div class="col-12">
        ...
        <div class="col-sm-12 col-md-12">
            <div class="box tabla-admin">
                <!-- TABLA SUPERADMIN -->
                <table id="tabla-orden-trabajo" class="table table-striped table-bordered base-style display table-responsive">
                    <thead>
                        <tr>
                            <th width="8%">COL_1</th>
