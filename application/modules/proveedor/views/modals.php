          ...
          <div class="col-md-12">
            ...
            <div class="row mt-3 mb-3">
              ...
              <div class="col-sm-12">
                <div class="form-group form-custom-icon-left">
                  <span class="form-custom-icon"><i class="fas fa-pen"></i></span>
                  <label for="form-proveedor-descripcion" class="custom-label">Descripcion</label>
                  <textarea name="descripcion" class="form-control" id="form-proveedor-descripcion" maxlength="255" style="height: 60px;"></textarea>
                </div>
              </div>
            </div>
            ...
            <div class="row mt-3 mb-3">
              ...
              <div class="col-sm-4 form-actions">
                <div class="form-group form-custom-icon-left">
                  <span class="form-custom-icon"><i class="fas fa-pen"></i></span>
                  <label for="form-proveedor-rubro" class="custom-label">Rubro</label>
            ...
            <div class="row mt-3 mb-3">
              ...
              <div class="col-sm-6">
                <div class="form-group form-custom-icon-left">
                  ...
                  <label for="form-proveedor-nombre-contacto" class="custom-label">Nombre Contacto</label>
              ...
              <div class="col-sm-6">
                <div class="form-group form-custom-icon-left">
                  ...
                  <label for="form-proveedor-rut-empresa" class="custom-label">Rut Empresa</label>
            ...
            <div class="row mt-3 mb-3">
              ...
              <div class="col-sm-6">
                <div class="form-group form-custom-icon-left">
                  <span class="form-custom-icon"><i class="fa fa-building"></i></span>
                  <label for="form-proveedor-direccion-sucursal" class="custom-label">Direccion Sucursal</label>
                  <input type="direccion-sucursal" name="direccion-sucursal" class="form-control" id="form-proveedor-direccion-sucursal" maxlength="100" required />
                </div>
              </div>
              ...
              <div class="col-sm-6">
                <div class="form-group form-custom-icon-left">
                  <span class="form-custom-icon"><i class="fa fa-city"></i></span>
                  <label for="form-proveedor-ciudad-sucursal" class="custom-label">Ciudad Sucursal</label>
                  <input type="ciudad-sucursal" name="ciudad-sucursal" class="form-control" id="form-proveedor-ciudad-sucursal" maxlength="100" required />
                </div>
              </div>
            </div>
